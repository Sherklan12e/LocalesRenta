...
const CrearAlquiler = () => {
    ...
    return (
        <div className='w-dvw bg-color_turquesa9 '>
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className={`max-w-4xl mx-auto p-8 ${darkMode ? 'bg-color_turquesa10 text-white ' : 'bg-white  text-black'} lg:px-8  rounded-lg shadow-xl`}
            >
                {showAlert && (
                    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  text-white p-4 rounded-lg shadow-lg z-50">
                        Alquiler publicado con éxito!
                    </div>
                )}
                <h2 className="text-4xl font-bold mb-8 text-center  border-b-2 border-blue-500 pb-4">Crear Nuevo Alquiler</h2>
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="titulo" className="flex items-center  font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="descripcion" className="flex items-center font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="precio" className="flex items-center  font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="ubicacion" className="flex items-center  font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="superficie" className="mb-2 font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <div className="flex flex-col">
                                <label htmlFor="num_habitaciones" className="mb-2 font-semibold"
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <div className="flex flex-col">
                                <label htmlFor="num_banos" className="mb-2 font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="num_garajes" className="mb-2  font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="ano_construccion" className="mb-2  font-semibold">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} className="flex flex-col space-y-2">
                            <label htmlFor="tipo_propiedad" className="mb-2 font-semibold">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} className="flex items-center space-x-2">
                            <input
                                ...
                                className="form-checkbox h-5 w-5 text-blue-600 transition duration-150 ease-in-out"
                            />
                            <label htmlFor="aire_acondicionado" className=" font-medium">
                    ...
                    >
                        <label htmlFor="imagenes" className="flex items-center  font-semibold">
