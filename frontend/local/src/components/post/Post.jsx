...
const PostPage = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                ...
                const response = await axios.get('https://fair-francine-davismendoza-08ett12-edf8c0dc.koyeb.app/api/posts/', {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('https://fair-francine-davismendoza-08ett12-edf8c0dc.koyeb.app/api/posts/', { content }, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleDelete = async (postId) => {
        try {
            ...
            await axios.delete(`https://fair-francine-davismendoza-08ett12-edf8c0dc.koyeb.app/api/posts/${postId}/`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
